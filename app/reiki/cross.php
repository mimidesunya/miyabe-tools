...
foreach (reiki_search_ready_summaries() as $municipality) {
        ...
        <aside class="side-stack">
            <section class="panel controls-panel">
                <div class="section-head">
                    <h2>検索条件</h2>
                    <p>本文キーワードを投げると、検索可能な自治体の例規集 DB を順に走査します。</p>
                </div>
        ...
        <main class="panel results-panel">
            <div class="results-head">
                <div>
                    ...
                    <p id="selected-meta" class="results-meta">例規集 DB を横断して、該当自治体と上位ヒットを並べます。</p>
                </div>
...
<script id="reiki-cross-boot" type="application/json"><?php echo json_encode($boot, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?></script>
<script src="/reiki/assets/js/cross.js?v=<?php echo h((string)$jsVer); ?>"></script>
</body>
</html>
