...
<head>
  ...
  $assetFiles = array_values(array_filter(array_map(
      'site_asset_disk_path',
      [
          'boards/assets/css/style.css',
          'boards/assets/js/api.js',
          'boards/assets/js/main.js',
          'boards/assets/js/map.js',
          'boards/assets/js/ui.js',
      ]
  )));
  $assetVer = $assetFiles !== [] ? max(array_map('filemtime', $assetFiles)) : 1;
  ?>
    ...
    <div
      ...
      <div style="padding:14px 16px; font-size:14px; color:#333; line-height:1.7;">
        ...
        <ul style="padding-left: 20px; margin: 0;">
          ...
          <li><b>⚠️ 異常:</b> 掲示場が破損している、他陣営のポスターで埋まっているなど、作業できない状態。</li>
      ...
      <div id="help-offset-section" style="display:none;">
        ...
        <p style="margin:0;">
          選管による位置変更や、実際の掲示場位置が地図とずれている場合などに使用します。<br>
