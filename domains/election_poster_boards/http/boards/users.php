<?php
// 選挙ポスター掲示場ツールのユーザーダッシュボードとタスクの一括割り振り
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'bulk_reassign') {
    ...
    try {
        $fromUserId = poster_boards_upsert_user($pdo, $me);
...
<body>
  ...
  <div class="container">
    ...
    <?php if (poster_boards_is_admin($me) && !empty($users)): ?>
    <div class="bulk-reassign">
      <h3>📋 一括割り振り</h3>
      <p class="muted" style="margin: 0 0 12px 0;">自分が着手中の掲示場を他のユーザーに一括で割り振ることができます。</p>
