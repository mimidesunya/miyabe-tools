#!/usr/bin/env python3
"""Convert KMZ files in kmzs/ to dev/boards/data/<municipality>/data.tsv.

使用方法:
  python domains/election_poster_boards/tools/convert_kmz.py
  python domains/election_poster_boards/tools/convert_kmz.py --geocode
"""
import argparse
import json
import time
...
BASE_KMZ = str(ROOT / "kmzs")
BASE_OUT = str(ROOT / "dev" / "boards" / "data")
