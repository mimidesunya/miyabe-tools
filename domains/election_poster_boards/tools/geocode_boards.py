...
# -*- coding: utf-8 -*-
"""
選挙ポスター掲示場データ（TSV）に緯度経度を付加するプログラム
...
2. python domains/election_poster_boards/tools/geocode_boards.py <入力TSV> <住所プレフィックス>
   例: python domains/election_poster_boards/tools/geocode_boards.py dev/boards/data/hino-shi/data.tsv "東京都日野市"
"""
