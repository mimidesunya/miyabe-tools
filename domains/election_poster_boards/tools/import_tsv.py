...
使用方法:
  python domains/election_poster_boards/tools/import_tsv.py <slug>
"""
...
def main() -> int:
    if len(sys.argv) < 2:
        print("使用法: python domains/election_poster_boards/tools/import_tsv.py <slug>")
        return 1

    slug = sys.argv[1]
    root = Path(__file__).resolve().parents[3]

    tsv_file = root / "dev" / "boards" / "data" / slug / "data.tsv"
