...
class IndexOutboxTest(unittest.TestCase):
    ...
    def test_attempt_limit_stops_the_sweep_and_asks_for_a_human(self) -> None:
        ...
        far_future = time.time() + 10 * 24 * 60 * 60
        self.assertEqual(index_outbox.due_slugs("reiki", now=far_future), [])
